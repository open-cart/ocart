...
{{--                                        <img src="/images/no-image.jpg" class="w-14"/>--}}
                                        <img src="{!! $plugin['AppConfig']->image !!}" class="w-14"/>
                                    </td>
                                    <td class="border p-2">{!! $plugin['AppConfig']->title !!}</td>
                                    <td class="border p-2">{!! $plugin['AppConfig']->version !!}</td>
                                    <td class="border p-2">
                                        {!! $plugin['AppConfig']->auth !!}
                                    </td>
                                    <td class="border p-2">
                                        <a href="{!! $plugin['AppConfig']->link !!}" target="_blank">Link</a>
                                    </td>
                                    <td class="border p-2">0</td>
                                    <td class="border p-2">
                                        @if($pluginsInstalled->has($plugin['AppConfig']->configKey))
                                            <div class="flex">
                                                @if($pluginsInstalled[$plugin['AppConfig']->configKey]->value)
                                                    <a href="javascript:void(0)"
                                                       title="{!! __('admin.plugins.action_disable_title') !!}"
                                                       x-on:click="disable('{!! $plugin['AppConfig']->configKey !!}')">
                                                        <div class="p-1">
                                                ...
                                                @else
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       x-on:click="enable('{!! $plugin['AppConfig']->configKey !!}')">
                                                       <div class="p-1">
                                                           <i data-feather="send" class="text-indigo-600"></i>
                                                       </div>
                                                    </a>
                                                @endif
                                                @if($plugin['AppConfig']->config())
                                                    <a href="#"
