...
class Shortcode
{
     ...
     * @since 2.1
     */
    public function register($key, string $name, $description = null, $callback = null)
    {
     ...
     * @since 2.1
     */
    public function strip(string $value)
    {
     ...
     * @return string
     */
    public function generateShortcode(string $name, array $attributes = [])
    {
        $parsedAttributes = '';
