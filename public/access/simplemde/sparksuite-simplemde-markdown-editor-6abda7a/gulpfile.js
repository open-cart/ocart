...
gulp.task("browserify:debug", gulp.series([gulp.parallel('lint')], function() {
...
gulp.task("scripts", gulp.series([gulp.parallel("browserify")], function() {
...
gulp.task("styles", gulp.series([gulp.parallel('prettify-css')], function() {
	var css_files = [
