/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+graphql+json+markup-templating+mongodb+php+jsx+regex+sql&plugins=show-language+toolbar */
...
!function () {
    if ("undefined" != typeof Prism && "undefined" != typeof document) if (Prism.plugins.toolbar) {
        Prism.plugins.toolbar.registerButton("show-language-bar", function (e) {
            var a = e.element.parentNode;
            $(e.element).before(`<svg xmlns="http://www.w3.org/2000/svg" width="54" height="14" viewBox="0 0 54 14"
