<x-guest-layout xmlns:x-theme="http://www.w3.org/1999/html">
    <div class="image-cover hero-banner bg-no-repeat bg-cover bg-center"
        ...
        <div class="container-custom py-20">
            <div id="dangkydaily" class="hero-search-wrap bg-white max-w-xl p-10 pt-8 shadow-md">
                <div class="hero-search">
                    <div class="hero-search-wrap">
                        <div class="hero-search mb-4">
                            <h1 class="text-4xl font-extrabold capitalize">Đăng ký làm đại lý của Tanaco Việt Nam</h1>
                        </div>
                        ...
                        <div class="hero-search-action">
                            <a href="#" class="btn block text-xl text-white bg-blue-600 p-5 w-full text-center rounded-md">Đăng ký</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="antialiased font-sans bg-red-500">
        <div class="container-custom call-to-act py-14 block sm:flex items-center">
            <div class="call-to-act-head text-white flex-1 mb-8 sm:mb-0">
                <h3 class="text-2xl font-bold">Đăng ký làm đại lý Tanaco Việt Nam</h3>
                <span>We'll help you to grow your career and growth.</span>
            </div>
            <a href="#dangkydaily" class="btn btn-call-to-act bg-white border-4 border-yellow-400 rounded-full py-4 px-8">Đăng ký ngay</a>
        </div>
    </section>
