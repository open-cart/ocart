                ...
                <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/3 p-4">
                    <a href="" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-500">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec
                                ullamcorper nulla non metus auctor fringilla.</p>
                            <div class="mt-3 flex items-center text-blue-600">
                                <span class="font-bold text-2xl">4.500.000</span>&nbsp;<span class="text-sm font-semibold">đ</span>
                            </div>
                        </div>
...
</svg> 210 Zirak Road, Canada
                            </span>
                        </div>
                        <div class="p-4 flex items-center text-sm text-gray-600 hidden">
