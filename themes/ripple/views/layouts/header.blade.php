    ...
    <div class="container-custom">
        ...
        <!-- End Menu Main -->
            ...
            <div class="hidden lg:flex items-center justify-end lg:flex-1 lg:w-0">
                ...
                @else
                    <a href="{!! route('login') !!}"
                       class="whitespace-nowrap inline-flex px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700">
