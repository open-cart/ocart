            ...
            <li class="list-sharing-item">
                <a href="tel:{{ preg_replace( '/[^0-9]/', '', get_phone() )}}" rel="nofollow"
                   class="list-sharing-item-icon">
                    ...
                    <span class="tooltip-list-sharing-item-text">Gọi ngay cho chúng tôi</span>
                </a>
            </li>
            <li class="list-sharing-item">
                <a href="https://zalo.me/{{ preg_replace( '/[^0-9]/', '', get_phone() )}}" target="_blank"
                   rel="nofollow" class="list-sharing-item-icon">
                    ...
                    <span class="tooltip-list-sharing-item-text">Chat với chúng tôi qua Zalo</span>
                </a>
            </li>
        @endif
        @if(!empty(get_fb_chat()))
            <li class="list-sharing-item">
                <a href="{{ get_fb_chat() }}" target="_blank" rel="nofollow"
                   class="list-sharing-item-icon">
                    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="tooltip-list-sharing-item-text">Chat với chúng tôi qua Facebook</span>
                </a>
            </li>
        @endif
        <li class="list-sharing-item">
            <a href="javascript:void(0)" rel="nofollow" data-toggle="modal" data-target="#form-contact-modal"
               class="list-sharing-item-icon">
                <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="tooltip-list-sharing-item-text">Đăng kí thông tin và để lại lời nhắn</span>
            </a>
        </li>
        <li class="list-sharing-item">
            <button id="gotop"
                ...
                <span class="tooltip-list-sharing-item-text">Di chuyển lên</span>
            </button>
        </li>
    </ul>
</div>
